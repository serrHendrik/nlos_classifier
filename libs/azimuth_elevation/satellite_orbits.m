...
% Variables
goGNSS.ELL_A_GLO = 6378136;
goGNSS.GM_GLO = 3.9860044e14; 
goGNSS.J2_GLO = 1.0826257e-3;
goGNSS.OMEGAE_DOT_GLO = 7.292115e-5;
goGNSS.OMEGAE_DOT_GPS = 7.2921151467e-5;             % GPS     Angular velocity of the Earth rotation [rad/s]
goGNSS.OMEGAE_DOT_GLO = 7.292115e-5;                 % GLONASS Angular velocity of the Earth rotation [rad/s]
goGNSS.OMEGAE_DOT_GAL = 7.2921151467e-5;             % Galileo Angular velocity of the Earth rotation [rad/s]
goGNSS.OMEGAE_DOT_BDS = 7.292115e-5;                 % BeiDou  Angular velocity of the Earth rotation [rad/s]
goGNSS.OMEGAE_DOT_QZS = 7.2921151467e-5;  
goGNSS.OMEGAE_DOT_GL = 7.292115e-5; 
switch char(Eph(31))
    case 'G'
        Omegae_dot = goGNSS.OMEGAE_DOT_GPS;
    case 'R'
        Omegae_dot = goGNSS.OMEGAE_DOT_GL;
    case 'E'
